...
Creator INTEGER,
ProjStatus INTEGER,
CONSTRAINT fk_projects_Creator FOREIGN KEY (Creator) REFERENCES profiles(ID) ON DELETE SET NULL);
...
CONSTRAINT fk_tasks_Project FOREIGN KEY (Project) REFERENCES projects(ID) ON DELETE SET NULL);
